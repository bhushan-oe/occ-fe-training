  ...
  function (ko,$,moment) 
  {
    ...
    return{
      ...
      { 
          ...
          var self = this;
          function heroBannerItem(imageUrl,mobileImageUrl,bannerLink,startDate,endDate,bannerText)
          {
          ...
          for(i=1;i<7;i++)
          {
              widget.bannerData.push(new heroBannerItem
                (
          ...
          //item validation
          var validItems = ko.computed(function()
          {
            ...
            {          
                ...
                if(item.imageUrl)
                {
                    ...
                    {
                        if(moment(currentDate).isSameOrAfter(item.startDate) && moment(currentDate).isSameOrBefore(item.endDate))
                        {
                          return item;
                        }
                    }
                    ...
                    {
                        if(moment(currentDate).isSameOrAfter(item.startDate))
                        {
                          return item;
                        }
                    }
                    ...
                    {
                        if(moment(currentDate).isSameOrBefore(item.endDate))
                        {
                          return item; 
                        }
                    }
